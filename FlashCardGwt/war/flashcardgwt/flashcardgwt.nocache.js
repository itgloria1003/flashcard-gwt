...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "flashcardgwt" because\n';
  ...
  $wnd.__gwt_activeModules['flashcardgwt'] = {
    'moduleName' : 'flashcardgwt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/flashcardgwt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['flashcardgwt'].superdevmode = true;

  var expectedSuffix = '/flashcardgwt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + flashcardgwt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:flashcardgwt';
  var devModeSessionKey = '__gwtDevModeSession:flashcardgwt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/flashcardgwt/flashcardgwt.nocache.js';
  ...
  $wnd.__gwt_activeModules['flashcardgwt'].canRedirect = true;
  $wnd.__gwt_activeModules['flashcardgwt'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING flashcardgwt';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/flashcardgwt?user.agent=' + ua + '&_callback=' + callback;
